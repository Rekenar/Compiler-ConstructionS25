...
public class Scanner {
	...
	private static final String key[] = { // sorted list of keywords
			"break", "case", "class", "default", "else", "final", "if", "new",
			"print", "program", "read", "return", "switch", "void", "while"
	};
	private static final int keyVal[] = { // token codes for keywords
			break_, case_, class_, default_, else_, final_, if_, new_,
			print_, program_, read_, return_, switch_, void_, while_
	};
